            ...
            '/sre/': [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            collapsed: true,
                            items: [
                                { text: '10. Compose 多服务与网络', link: `/sre/devops/intermediate/compose-network` },
                                { text: '11. 数据持久化与挂载', link: `/sre/devops/intermediate/compose-storage` },
                                { text: '12. Dockerfile 构建与运行时配置', link: `/sre/devops/intermediate/environment` },
                                { text: '13. 制品库与镜像仓库', link: `/sre/devops/intermediate/13-image-registry` },
                                { text: '14. 健康检查与启动依赖', link: `/sre/devops/intermediate/compose-health` },
                                { text: '15. CI/CD 权责分离', link: `/sre/devops/intermediate/cicd-separation` },
                                { text: '16. 持续集成流水线', link: `/sre/devops/intermediate/ci-pipeline` },
                                { text: '17. Compose 持续发布', link: `/sre/devops/intermediate/cd-pipeline` },
                                { text: '18. 轻量 K3s 集群', link: `/sre/devops/intermediate/k3s` },
                                { text: '19. K8s 应用部署', link: `/sre/devops/intermediate/16-k8s-app-deploy` },
                                { text: '20. K8s 配置与密钥', link: `/sre/devops/intermediate/17-configmap-secret` },
                                { text: '21. 多环境隔离与制品晋级', link: `/sre/devops/intermediate/18-env-separation` },
                                { text: '22. 数据库迁移与发布兼容性', link: `/sre/devops/intermediate/19-db-migration` },
                            ]
                        },
                        {
                            text: 'DevOps 高级篇',
                            collapsed: true,
                            items: [
                                { text: '23. 质量门禁卡点设计', link: `/sre/devops/advanced/quality-gate` },
                                { text: '24. 制品防篡改与 SBOM', link: `/sre/devops/advanced/sha-SBOM` },
                                { text: '25. GitOps 发布实践', link: `/sre/devops/advanced/gitops` },
                                { text: '26. 交付边界与灰度', link: `/sre/devops/advanced/what-is-cd` },
                                { text: '27. 变更管控就绪清单', link: `/sre/devops/advanced/change-management` },
                                { text: '28. 变更防错与 AI 价值', link: `/sre/devops/advanced/change-control` },
                                { text: '29. 全局自动化发布：结课项目', link: `/sre/devops/advanced/cloud-native-cicd` },
                                { text: '30. 一站式平台反思（选读）', link: `/sre/devops/advanced/devops-platform` },
                            ]
                        },
                        {
                            text: 'DevOps 加餐篇',
                            collapsed: true,
                            items: [
                                { text: '31. 静态网页发布', link: `/sre/devops/extra/front-dist` },
                                { text: '32. Spring 应用部署', link: `/sre/devops/extra/spring` },
                                { text: '33. 多模块 Git 协作', link: `/sre/devops/extra/git-submodule` },
                                { text: '34. SRE 核心能力', link: `/sre/devops/extra/devops-core` },
                            ]
                        },
                        {
                            text: '可观测性',
