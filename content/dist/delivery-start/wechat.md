...
1. DevOps 基础 01 ｜ Nginx 静态资源代理（系列化）
2. 编程有 Hello World，运维的 Hello World 是 Nginx 代理这一行 HTML
3. 从一行 index.html 到 VitePress 上线：Nginx 静态资源代理的最小闭环

**选用**：1（系列化命名，后续 02–09 沿用「DevOps 基础 NN ｜ 标题」格式）
...
<!-- ⚠️ 公众号发布：图片 https://media.xiaolin.fun/docs/img-delivery-start/vitepress-home.png 需手动上传至微信后台 -->

**VitePress 文档页面示例：**

![VitePress 文档页面](https://media.xiaolin.fun/docs/img-delivery-start/vitepress-docs.png)
<!-- ⚠️ 公众号发布：图片 https://media.xiaolin.fun/docs/img-delivery-start/vitepress-docs.png 需手动上传至微信后台 -->

**VitePress 开发与发布闭环工作流：**

![VitePress 开发与发布闭环流程](https://media.xiaolin.fun/docs/img-delivery-start/vitepress-workflow-aligned.png)
<!-- ⚠️ 公众号发布：图片 https://media.xiaolin.fun/docs/img-delivery-start/vitepress-workflow-aligned.png 需手动上传至微信后台 -->
...
VitePress 适合开发者灵活地管理静态站点，好处是仅需关注 Markdown 文档和配置文件。但需要注意的是，每次无论大小修改，均需要重新构建和发布。在运维领域，这属于一次**生产变更**，是比较敏感的操作。
...
完整版与延伸阅读 → https://xiaolinstar.cn/sre/devops/foundation/delivery-start.html
